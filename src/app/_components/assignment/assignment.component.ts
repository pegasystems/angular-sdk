...
export class AssignmentComponent implements OnInit {
  ...
  ngOnChanges() {
    ...
    // This gets fired before the initial onInit. So need to accommodate
    //  this here, too...

    const pConnType = this.pConn$.getComponentName();
    console.log(`Assignment pConn$ type: ${pConnType}`);
    ...
    if (pConnType === 'reference') {
      ...
      // and update this.arChildren$ to be the referenced View's children
