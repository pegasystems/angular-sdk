...
# Angular SDK - Release Announcement - v25.1.12

The **SDK-A v25.1.12** release is **only compatible with Pega Infinity '25**. This release is available in the [**release/25.1.12**](https://github.com/pegasystems/angular-sdk/tree/release/25.1.12) branch of the Angular SDK repository.

**Note**: The main branch is the active development branch for future versions of Angular SDK.

The SDK-A v25.1.12 release allows Angular SDK users to take advantage of the latest SDK enhancements and fixes. For more information, see
[What's new in SDK-A 25.1.12](https://docs.pega.com/bundle/constellation-sdk/page/constellation-sdks/sdks/angular-sdk-updates.html).
